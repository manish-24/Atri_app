...
class Atri:
	...
	@property
	def Div_8(self):
		self._getter_access_tracker["Div_8"] = {}
		return self._Div_8
	@Div_8.setter
	def Div_8(self, new_state):
		self._setter_access_tracker["Div_8"] = {}
		global default_state
		self._Div_8 = Div(new_state, default_state["Div_8"])
